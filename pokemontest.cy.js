describe('Покупка аватара', function () {                                // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[type="email"]').type('Usher0307@yandex.ru');      // вводим логин
         cy.get('input[type="password"]').type('030775Eau');             // вводим пароль
         ...
         cy.get('.k_input_name').type('ELENA');                           // вводим имя владельца действия карты
